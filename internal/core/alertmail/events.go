...
var alerts = map[string]Alert{
	...
	amodel.TypeTOTPRecoveryUsed: {TierAccount,
		"A recovery code was used to sign in",
		"One of your two-factor recovery codes signed in instead of your authenticator app. If this was not you, change your password now and generate a new set of codes - the old ones may be in somebody else's hands."},
